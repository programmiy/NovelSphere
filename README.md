...
NovelSphere는 웹 기반의 라노벨 번역 지원 도구입니다. FastAPI 백엔드와 웹 UI를 통해 번역 작업을 효율적으로 관리하고, Celery를 활용한 비동기 작업 처리로 대규모 번역 및 크롤링 작업을 안정적으로 수행합니다. Pydantic 기반의 설정 관리, SQLAlchemy를 통한 데이터베이스 관리, 그리고 Pytest를 활용한 테스트 자동화로 프로젝트의 안정성과 유지보수성을 높였습니다.
